const details = [
  ...
  },
  {
    ...
    experienceLinks: [
      {
        ...
        id: 1007,
        label: "Warner",
        link: "https://www.international.tbs.com/"
      },{
        id: 1008,
        label: "BIT Certs",
    ...
    myExperience: [
      ...
      "Durante casi dos años, fui consultor para Techint, una empresa de importación de materiales industriales, donde formé parte del equipo de PREMO para mejorar la experiencia de usuario del sitio web, la mejora de la performance de mismo y la implementación de nuevas funcionalidades y requerimientos solicitados por el cliente.",
      "También participé en el desarrollo de un plugin integrado con el ecosistema de la aplicación web para agilizar la generaración de las invitaciones a cotizar para los proveedores y actualizar el estado de las mismas sin necesidad de salir del outlook actulizando el estado de las cotizaciones en tiempo real.",
    ],
    experienceLinks: [
      {
        id: 1005,
